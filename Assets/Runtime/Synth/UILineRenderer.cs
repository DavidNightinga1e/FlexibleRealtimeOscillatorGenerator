...
namespace Runtime.Synth
{
	...
	public class UILineRenderer : MaskableGraphic
	{
		...
		protected override void OnPopulateMesh(VertexHelper vh)
		{
			...
			if (m_UseMargins)
			{
				if (m_RelativeSize)
				{
					...
					pointList[pointList.Length - 1] = new Vector2(rectTransform.rect.width - m_Margin.x,
						rectTransform.rect.height - m_Margin.y);
				}
				else
				{
		...
		private void DrawLine(Vector2[] points, VertexHelper vh)
		{
			...
			{
				DrawLineSegment(points[i], points[i + 1], vh, i == 0 && m_AddStartCap,
					i == points.Length - 2 && m_AddEndCap);
			}
